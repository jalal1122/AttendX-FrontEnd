...
const Class = () => {
  ...
  return (
    <>
      ...
      <div
        className="Main-Container w-full h-[100vh]"
        style={{
          backgroundColor: colors.Secondary,
          // color: colors.Text.Primary,
        }}
      >
        <div className="w-full h-[91vh] flex flex-row rounded-xl">
          {/* Navigation Tab */}
          <NavigationTab
          ...
          />
          <div className="flex flex-col m-2 md:flex-row gap-6 w-full h-full p-6 rounded-xl">
